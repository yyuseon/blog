...
<div class="memo-box">
최신 연도의 의료비 지출 기준으로 한국은 OECD 36개국 중 18위에 해당한다. 의료비 증가량만 놓고 보면 한국은 상위 그룹에 속한다. 기대수명 증가량은 OECD 36개국 중 2위이다. 이러한 결과는 한국의 의료비 지출 증가가 단순한 비용 증가에 그치지 않고, 실제로 국민 건강 향상에도 긍정적인 영향을 주었음을 시사한다.</div>
